...
IMPLE_MAPPER = {
    'none': "none",
    "cpython-38": ['none', 'cp38', 'cp38m'],
    "cpython-37": ['none','cp37', 'cp37m'],
    "cpython-36": ['none','cp36', 'cp36m'],
    "cpython-35": ['none','cp35', 'cp35m'],
    "cpython-34": ['none','cp34', 'cp34m'],
    "all": ['none', 'cp38m', 'cp37m', 'cp36m', 'cp35m', 'cp34m', 'cp33m',
            'cp38', 'cp37', 'cp36', 'cp35', 'cp34', 'cp33']
}

PLATFORM_MAPPER = {
    "win32": ['win_amd64', 'win32', 'any'],
    "linux": ['any', 'manylinux1_x86_64', 'manylinux1_i686', 'manylinux2010_x86_64',
